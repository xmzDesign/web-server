package com.xmz.core.response;

import static com.xmz.core.constant.CharConstant.BLANK;
import static com.xmz.core.constant.CharConstant.CRLF;
import static com.xmz.core.constant.CharsetProperties.UTF_8_CHARSET;
...
public class Response {
		...
		public void write() {
				...
				if(body == null){
						...
						body(bodyAppender.toString().getBytes(UTF_8_CHARSET));
				}
