package com.xmz.core.request;

import com.xmz.core.constant.CharConstant;
...
import com.xmz.core.request.dispatcher.impl.ApplicationRequestDispatcher;
import com.xmz.core.servlet.context.ServletContext;
import com.xmz.core.enums.RequestMethod;
import com.xmz.core.servlet.base.RequestHandler;
...
public class Request {
		...
		public Request(InputStream in) throws RequestParseException, RequestInvalidException {
				...
				try {
						//支持中文，对中文进行URL解码
						lines = URLDecoder.decode(new String(buf, CharsetProperties.UTF_8_CHARSET), CharsetProperties.UTF_8).split(
								CharConstant.CRLF);
